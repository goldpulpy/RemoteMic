...
[🚀 Быстрый старт](#быстрый-старт) · [🎚 Качество аудио](#качество-аудио) · [🛠 Установка](#установка) · [🔒 Безопасность](#модель-безопасности) · [❓ Устранение неполадок](#устранение-неполадок) · [📄 Лицензия](#лицензия)
...
- Убедитесь, что на странице отображается **Streaming over LAN**.
